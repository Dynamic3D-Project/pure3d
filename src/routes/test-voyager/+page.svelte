...
<div class="container mx-auto max-w-6xl px-4 py-12">
	<div class="mb-8 text-center">
		<h1 class="mb-4 text-4xl font-bold">Voyager Setup Test</h1>
		<p class="text-base-content/70">Testing your locally hosted Voyager installation</p>
	</div>
	...
	<div class="card mb-8 bg-base-200 shadow-xl">
		<div class="card-body">
			...
			<div class="mt-4 alert alert-info">
				...
				<span class="text-xs">
					These should open Voyager without any models (empty viewer). If you see errors, check that
					Voyager is in static/voyager/
				</span>
			</div>
		</div>
	</div>
	...
	<div class="card mb-8 bg-base-200 shadow-xl">
		<div class="card-body">
			...
			<div class="mb-4 alert alert-warning">
				...
				<div>
					<p class="text-sm font-bold">This needs your own 3D model</p>
					<p class="text-xs">
			...
			<div class="mt-4 alert alert-info">
				...
				<div class="text-xs">
					<p class="mb-2 font-bold">Expected Results:</p>
		...
		<div class="card-body">
			...
			<div class="space-y-3">
				...
				<div class="form-control">
					<label class="label cursor-pointer justify-start gap-3">
						<input type="checkbox" class="checkbox checkbox-primary" />
						<span class="label-text"> Test 1: Direct HTML links work </span>
					</label>
				</div>
				...
				<div class="form-control">
					<label class="label cursor-pointer justify-start gap-3">
						<input type="checkbox" class="checkbox checkbox-primary" />
						<span class="label-text"> Test 2: Iframe mode shows Apollo 11 model </span>
					</label>
				</div>
			...
			<div class="prose prose-sm max-w-none">
				<h3 class="mb-2 text-base font-semibold">Quick Commands</h3>
				<div class="mockup-code text-xs">
					<pre><code
							># Check if Voyager files exist
